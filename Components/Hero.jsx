        ...
        <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              <p className="max-w-xl md-4 text-base text-gray-200 md:text-lg">
                Sed ut perspiciatis unde omnis iste natus error sit valupatem
                accusantium doloremque laudan, totam rem aperiam, eaqua
                ipsaquae.
              </p>
              <a
                href="/"
                aria-label=""
                className="inline-flex items-center font-simibold tracking-wider transition-colors duration-200 text-teal-accent-400 hover:text-teal-accent-700 text-gray-200"
              >
                Learn more
                <svg
              ...
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                <form onSubmit={(e) => {e.preventDefault()}}>
                  <div className="mb-1 sm:mb-2">
                    ...
                    appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                      id="firstName"
                      name="firstName"
                    />
                  </div>
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      required
                      type="text"
                      className="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border-gray-300 rounded shadow-sm
                    appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                      id="lastName"
                      name="lastName"
                    />
                  ...
                  <div className="mt-4 mb-2 sm:mb-4">
                    <button
                      onClick={(e) => createCampaign(campaign)}
                      type="submit"
